...
namespace SpaceInvaders
{
    public class TimerEventMan : ManBase
    {
        ...
        public TimerEventMan(int reserveNum, int reserveGrow)
                : base(new PriorityQueueMan(), new DLinkMan(), reserveNum, reserveGrow)   
        {
            //LTN - TimerEventMan
            ...
            TimerEventMan.pActiveInstance = null;
        }
        ...
        {
            TimerEventMan pMan = TimerEventMan.pActiveInstance;
        ...
        public static TimerEvent Add(TimerEvent.Name timeName, Command pCommand, float deltaTimeToTrigger)
        {
            ...
            float triggerTime = TimerEventMan.GetCurrTime() + deltaTimeToTrigger;

            TimerEvent pNode = (TimerEvent)pMan.baseAdd(triggerTime);
        ...
        public static void SetActive(TimerEventMan pMan)
        {
            Debug.Assert(pMan != null);
            TimerEventMan.pActiveInstance = pMan;
        }
        ...
        private static TimerEventMan pActiveInstance = null;
