...
namespace SpaceInvaders
{
    public class SpriteGameProxy : SpriteBase
    {
        ...
        public void SwapImage(SpriteGame.Name _newSpriteName)
        {
            this.pRealSprite = SpriteGameMan.Find(_newSpriteName);
        }
        public void SwapColor(Azul.Color _color)
        {
            this.pRealSprite.SwapColor(_color);
        }
