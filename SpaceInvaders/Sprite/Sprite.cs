...
namespace SpaceInvaders
{
    public class Sprite : DLink
    {
        ...
        public Sprite() : base()   // <--- Delegate (kick the can)
        {
            this.x = 0.0f;
            this.y = 0.0f;
            this.sx = 1.0f;
        ...
        public void Set(Name name, Image.Name pImage, float x, float y, float w, float h)
        {

            Debug.Assert(this.poAzulSprite != null);
            Debug.Assert(this.poColor != null);

            this.pImage = ImageMan.Find(pImage);
