...
namespace SpaceInvaders
{
    public class SpriteBatchMan : ManBase
    {
        ...
        public SpriteBatchMan(int reserveNum = 1, int reserveGrow = 1)
                : base(new PriorityQueueMan(), new DLinkMan(), reserveNum, reserveGrow)   // <--- Kick the can (delegate)
        {
           /* //LTN - SpriteBatchMan
        ...
        public static SpriteBatch Add(SpriteBatch.Name name, int priority = 0, int reserveNum = 3, int reserveGrow = 1)
        {
            SpriteBatchMan pMan = SpriteBatchMan.psActiveSBMan;
            Debug.Assert(pMan != null);
