...
namespace SpaceInvaders
{
    public class SpriteFont : SpriteBase
    {
        ...
        public void Set(Font.Name name, String pMessage, Glyph.Name glyphName, float xStart, float yStart, float _scale = 1.0f)
        {
        ...
        override public void Render()
        {
            ...
            for (int i = 0; i < this.pMessage.Length; i++)
            {
                ...
                xTmp = xEnd + (pGlyph.GetAzulRect().width * this.scale) / 2;
                this.poScreenRect.Set(xTmp, yTmp, pGlyph.GetAzulRect().width * this.scale, pGlyph.GetAzulRect().height * this.scale);
                ...
                xEnd = (pGlyph.GetAzulRect().width * this.scale)/ 2 + xTmp;
            }
        }
        ...
        override public void Dump()
        {
            ...
            Debug.WriteLine("   {0} ({1})", this.fontName, this.GetHashCode());
