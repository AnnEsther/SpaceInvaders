...
namespace SpaceInvaders
{
    ...
    abstract public class ManBase
    {
        ...
        public NodeBase baseAdd(float triggerTime = 0.0f)
        {
            ...
            //pNodeBase.SetPriority(triggerTime);
            // Update stats
            this.mNumActive++;
            this.mNumReserved--;

            // copy to active
            poActive.AddToFront(pNodeBase, triggerTime);
        ...
        protected void baseClear()
        {
            ...
            {
                NodeBase pNodeCurrent = pItActive.Current();
                pNodeActive = pItActive.Next();
                this.baseRemove(pNodeCurrent);
                i++;
            }
            Debug.WriteLine("  Removed :  {0}: -------------", i);
