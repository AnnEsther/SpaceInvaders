...
namespace SpaceInvaders
{
    public class ColObject
    {
        public ColObject(SpriteGameProxy pSpriteGameProxy)
        {
            ...
            // this.pColSprite.SetColor(1.0f, 0.0f, 0.0f);
        ...
        public void UpdateColor(float red, float green, float blue, float alpha = 1.0f)
        {
            this.pColSprite.SetColor(red, green, blue, alpha);
        }
